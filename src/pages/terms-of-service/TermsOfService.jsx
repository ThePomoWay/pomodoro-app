  ...
  return (
    <div className="container">
      ...
      <div className={styles["main-content"]}>
        ...
        <h3 className="font-sub-heading">Using our Services</h3>
        <p className="font-info">
          ...
          Services. In connection with your use of the Services, we may send you
          service announcements, administrative messages, and other information.
          You may opt out of some of those communications. Most of our Services
          are available on mobile devices. Do not use such Services in a way
        ...
        <h3 className="font-sub-heading">About Software in Our Services</h3>
        <p className="font-info">
        ...
        <h3 className="font-sub-heading">Our Warranties and Disclaimers</h3>
        <p className="font-info">
          ...
          EXPRESSLY SET OUT IN THESE TERMS OR ADDITIONAL TERMS, NEITHER TIMEDOJO
          NOR ITS SUPPLIERS OR DISTRIBUTORS MAKE ANY SPECIFIC PROMISES ABOUT THE
          SERVICES. SOME JURISDICTIONS PROVIDE FOR CERTAIN WARRANTIES, LIKE THE
          IMPLIED WARRANTY OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE
          AND NON-INFRINGEMENT. TO THE EXTENT PERMITTED BY LAW, WE EXCLUDE ALL
          WARRANTIES.
        </p>
        <h3 className="font-sub-heading">Limits on Liability</h3>
        <p className="font-info">
          ...
          PROVIDED "AS IS". WE CANNOT PREDICT WHEN ISSUES MIGHT ARISE WITH OUR
