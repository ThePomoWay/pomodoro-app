  ...
  return (
    <div className={styles["container"]}>
      ...
      <div className={styles["main-content"]}>
        ...
        <h2 className="font-heading">FocusLounge Privacy Policy</h2>
        <p className="font-info">
          ...
          us at feedback@focuslounge.in
        </p>
        <h2 className="font-heading">Information FocusLounge Collects</h2>
        <h3 className="font-sub-heading">Your activity & apps</h3>
        <p className="font-info">
          At the time you register for FocusLounge, you voluntarily give us
        ...
        <p className="font-info">
          ...
          access FocusLounge. The user data we collect is used to enhance FocusLounge
        ...
        <h2 className="font-heading">Why FocusLounge Collects Data</h2>
        <p className="font-info">
        ...
        <p className="font-info">
          FocusLounge collects email addresses from those who communicate with us
        ...
        <h3 className="font-sub-heading">
          Protect FocusLounge, our users, and the public
        </h3>
        <p className="font-info">
          ...
          FocusLounge, our users, or the public. We use different technologies to
          ...
          feedback@focuslounge.in to ask for our confirmation whenever you feel
          concerned about how your personal information is being processed,
          where and for what purpose.
        </p>
        <h3 className="font-heading">Your Privacy Controls</h3>
        <p className="font-info">
          While FocusLounge owns the FocusLounge application's code, databases, and
          all rights, you retain all rights to your data. You have choices
          regarding the information we collect and how it's used. FocusLounge will
        ...
        <p className="font-info">
          FocusLounge is built with strong security features that continuously
          ...
          protect you and FocusLounge from unauthorized access, alteration,
        ...
        <p className="font-info">
          ...
          to use FocusLounge, you are agreeing to be bound by the revised policy.
        </p>
