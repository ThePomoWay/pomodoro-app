...
export default function Timer(){
        ...
        return ( 
            <div className={`${styles.timer}`}>
                ...
                <div className={`${styles.round} grid grid-center`}>
                    ...
                    <div className={styles["box"]}>
                        ...
                        <div id="water" className={styles["water"]} style={{transform: 'translate(0'+','+(100-percentComplete)+'%)'}}>
                            <svg viewBox="0 0 560 20" className={`${styles["water_wave"]} ${styles["water_wave_back"]}`}>
                            <use href="#wave"></use>
                            </svg>
                            <svg viewBox="0 0 560 20" className={`${styles["water_wave"]} ${styles["water_wave_front_2"]}`}>
                            <use href="#wave"></use>
                            </svg>
