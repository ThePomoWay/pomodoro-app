...
import { register } from "../../state/slices/OnboardingThunk";
...
export function SignupForm(props) {
  ...
  let validate = (vals) => {
    ...
    setErrors(errors);
    return (
      errors.emailError || errors.passwordError || errors.confirmPasswordError
    );
  };
  return (
              ...
              <Field name="email" type="text" placeholder="Enter your email">
                {({ input, meta }) => (
                  <TextField
                    ...
                    helperText={
                      !meta.active && meta.dirty && errors.emailError
