        ...
        <div className={styles['edit-task']}>
            ...
            <div className={styles['cta-row']}>
                <div className={styles['estimated-pomos']}>
                    <span className={styles['estimated-pomos-text']}>Estimated Pomodoros: </span>
