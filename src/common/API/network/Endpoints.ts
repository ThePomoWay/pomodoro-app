...
export const markTaskAsCompleteEndpoint = 'v1/user/{userId}/task/{taskId}/complete';
export const markTaskAsIncompleteEndpoint = 'v1/user/{userId}/task/{taskId}/incomplete'
